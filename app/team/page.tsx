...
export default function Page() {
  return (
    <main className="">
      <Navbar />
      <div className="bg-text-col min-h-screen h-full w-full relative pb-40">
        <div className="w-full relative text-color1 min-h-screen h-full pt-40 items-center bg-text-col flex flex-col">
