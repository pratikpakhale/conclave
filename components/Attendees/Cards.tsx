                ...
                <div className="p-6 flex flex-col space-y-4">
                  ...
                  >
                    ...
                    <a
                      ...
                      target="_blank"
                      className="font-semibold cursor-pointer text-slate-700 block z-20 hover:text-blue-600/90"
                    >
                      {third_year_poc}
                    </a>
                    ...
                    <a
                      ...
                      target="_blank"
                      className="font-semibold cursor-pointer text-slate-700 leading-4 block z-20 hover:text-blue-600"
                    >
                      {fourth_year_poc}
                    </a>
                    {/* <p className="text-slate-600 leading-4">
