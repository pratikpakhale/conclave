...
export default function TimeLine() {
  return (
    ...
    >
      ...
      <div className="bg-color1 px-4 py-20 w-full flex items-center gap-4 flex-col">
      ...
      <div className="relative flex flex-col items-left justify-center w-full">
        <div className="absolute z-[-2] w-[3px] left-[40px] md:left-[90px] h-full bg-[#414141]">
          <div className="fixed left-auto top-0 right-auto bottom-[50vh] z-[-1] w-[3px] h-[50vh] bg-white bg-[linear-gradient(180deg,#ff5c1f_50%,#fcab2e,#f79b04)]"></div>
        </div>
