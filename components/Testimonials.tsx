...
const TestimonialsPage = () => {
  ...
  return (
    <div className='relative h-screen w-full bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center overflow-hidden'>
      <h1 className='absolute text-4xl font-bold text-center text-gray-800 z-50'>
        In Their Own Words
      </h1>
